...
<div id="container">
		...
		<div id="content">
       	  ...
       	  <p>&nbsp; </p>
       	  <p>
       	    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="811" height="426" align="middle" id="FlashID" title="gary">
       	      <param name="movie" value="gary5.swf" />
       	      ...
       	      <!--[if !IE]>-->
       	      <object data="gary5.swf" type="application/x-shockwave-flash" width="811" height="426" align="middle">
       	        <!--<![endif]-->
       	        <param name="quality" value="high" />
       	        <param name="wmode" value="opaque" />
       	        <param name="swfversion" value="8.0.35.0" />
